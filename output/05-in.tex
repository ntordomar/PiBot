...
$\pi_{\text{nombre}}$
\\
\hspace{0.5em}\fontsize{14}{12}\selectfont$\sigma_{\fontsize{10}{5}\multiline{\text{materia}\ \text{IN}\ ($\pi_{\text{materia}}$
\fontsize{14}{12}\selectfont$\sigma_{\fontsize{10}{5}\multiline{\text{alumno} = \text{''Juan''}}}$
\textbf{(inscripcion)}
)}}$
\textbf{(materia)}
}
